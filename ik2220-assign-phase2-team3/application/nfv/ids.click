...
Total HTTP packet:				$(TestCounter1.count)
# of SQL DROP:				        $(TestCounter2.count)
# of SQL PASS :					$(TestCounter5.count)
# of HTTP POST:					$(TestCounter3.count)
# of HTTP GET DROP:				$(Blocked2.count)
# of HTTP HEAD DROP:				$(Blocked3.count)
# of HTTP OPTIONS DROP:				$(Blocked4.count)
# of HTTP TRACE DROP:				$(Blocked5.count)
# of HTTP DELETE DROP:				$(Blocked6.count)
# of HTTP CONNECT DROP:				$(Blocked7.count)
# of OUTPUT TO NET:				$(TestCounter4.count)
